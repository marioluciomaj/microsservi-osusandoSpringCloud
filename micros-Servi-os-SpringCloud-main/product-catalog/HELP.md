...
* The original package name 'one.digitalinnocation.experts.product-catalog' is invalid and this project uses 'one.digitalinnocation.experts.productcatalog' instead.
